...
# for num in numlist:
if 1==1:
    datadir=pwd+'/../Data/Grids_withCN_0916_75'#+num+'_20hz'


    scriptdir=pwd

    # stafile=scriptdir+'/../pts-in_important.lst'
    stafile=scriptdir+'/../pts-in_595.lst'
    ...
    perturbVal='0'; perturbThick='1' #first column options
    perturbPerc='-1'; perturbAbs='1' #2nd col options (percent vs absolute)
    ...
    #    '''
        ...
        ax2=plt.subplot2grid((3,2), (0,1)) #Phase
        ax3=plt.subplot2grid((3,2), (1,1)) #H/V
        ax4=plt.subplot2grid((3,2), (2,1)) #RF
    ...
    #    ax2.set_xlim([0.0,20.0])
        ...
        axs[0].set_title('NTW_H14', fontsize=24)
    ...
    #       printcrusttmp=printcrusttmp+' %5.6f'%(FCcrustcoeff[kk])
        ...
        if os.path.isfile(fname):
            ...
            rerunallstas=rerunallstas+inparacrustVs0+inparacrustVs1+inparacrustVs2+inparacrustVs3+inparacrustVs4+\
                                inparacrustVs5#+inparacrustVs6+inparacrustVs7
            #rerunallstas = inparacrustVs1+inparacrustVs2+inparacrustVs3+inparacrustVs4+inparacrustVs5+inparacrustVs6
            ##Mantle
            rerunallstas=rerunallstas+inparamantleVs0+inparamantleVs1+inparamantleVs2+inparamantleVs3#+inparamantleVs4
