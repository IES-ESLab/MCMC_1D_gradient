...
if 1==1:
    ...
    locals()['inparasedthick'] = perturbThick+' '+perturbAbs+' '+pertRangSedThick+' '+gwstepsedthick+' '+Sedlayerid
...
#    
    ...
    for zz,sta in enumerate (staarr):
        ...
        # lower value by 80%
        print("Lower values by 60% for VR12")
        modvs=modvs*1.0;
        if sed_flag==0:
            sed_value=modvs[0];
        else:
        ...
        # 
            ...
            if (sed_flag==1)&(mod_type_flag==1):
                ...
                ax1.plot(mod_vs,mod_d,'r--',label='Inverted Vs Model')
